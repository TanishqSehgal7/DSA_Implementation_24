...
public class PrimsAlgorithm {
	...
	static int numberOfNodes = scn.nextInt();
	static int numberOfEdges = scn.nextInt();
	static int[] parent = new int[numberOfNodes];
	static int[] key = new int[numberOfNodes];
	static boolean[] mst = new boolean[numberOfNodes];
