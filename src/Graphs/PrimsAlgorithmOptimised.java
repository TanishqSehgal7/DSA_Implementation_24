...
import Graphs.PrimsAlgorithm.Pair;
...
public class PrimsAlgorithmOptimised {
	...
	public static ArrayList<Integer> primsAlgo(int source, ArrayList<Integer> parent, ArrayList<Boolean> mst) {
		...
		while(!pq.isEmpty()) {
			...
			System.out.println("Front node is: " + front.node + " with weight " + front.weight);
			...
			/* In Java priority queue is a min heap, Pairs are arranged as per their weight
			and for the pairs having same weight, they are arranged as per their relative order
			of insertion.
			*/
